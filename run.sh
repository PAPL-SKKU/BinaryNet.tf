...
# python evaluate.py --model cifar10 --checkpoint_dir ./results/float_cifar10 --dataset cifar10 --gpu True
# python3 evaluate.py --model cifar10 --checkpoint_dir ./results/float_cifar10 --dataset cifar10 --gpu True

python3 main.py --model alexnet --save cifar10 --dataset cifar10 --gpu True
